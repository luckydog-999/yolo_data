...
# --- 黑科技：静音渲染 (屏蔽 Blender 的 Saved 刷屏信息) ---
...
def main():
    ...
    create_or_get_floor() # 确保地板存在
    apply_zed_intrinsics(cam)
    setup_camera_tracking(obj)
    ...
    # 使用 Tqdm 显示进度条
    # ncols=80 控制宽度，ascii=True 防止某些终端乱码
